...
public class EditCommand extends Command {
    ...
    private static Client createEditedPerson(Client clientToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Set<Order> orderSet = editPersonDescriptor.getOrders().orElse(clientToEdit.getOrders());

        return new Client(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedTags, orderSet);
    }
